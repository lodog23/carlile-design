...
function project_post_type() {
	...
	register_post_type( 'cd_project', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	...
	*/
	...
	register_taxonomy( 'cd_project_type',
		array('cd_project'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				...
				'new_item_name' => __( 'New CProject Type Name', 'bonestheme' ) /* name title for taxonomy */
			),
